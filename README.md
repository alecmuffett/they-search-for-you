...
* :repeat: [RSS Feed: Socially Problematic Content](https://www.theyworkforyou.com/search/rss/?s=%22algorithms%22+OR+%22cross-platform+harms%22+OR+%22disinformation%22+OR+%22fake+news%22+OR+%22free+speech%22+OR+%22harmful+content%22+OR+%22hate+speech%22+OR+%22revenge+porn%22+OR+%22vawg%22)
...
* :point_right: [Search: Trite Expressions](https://www.theyworkforyou.com/search/?q=%22illegal+offline%22+OR+%22illegal+online%22+OR+%28+illegal+offline+online+%29+OR+%28+prohibited+offline+online+%29+OR+%28+unacceptable+offline+online+%29+OR+%22privacy+by+design%22+OR+%22safe+by+design%22+OR+%22safety+by+design%22+OR+%22secure+by+design%22+OR+%22security+by+design%22+OR+%22surveillance+capitalism%22+OR+%22wild+west%22)
* :repeat: [RSS Feed: Trite Expressions](https://www.theyworkforyou.com/search/rss/?s=%22illegal+offline%22+OR+%22illegal+online%22+OR+%28+illegal+offline+online+%29+OR+%28+prohibited+offline+online+%29+OR+%28+unacceptable+offline+online+%29+OR+%22privacy+by+design%22+OR+%22safe+by+design%22+OR+%22safety+by+design%22+OR+%22secure+by+design%22+OR+%22security+by+design%22+OR+%22surveillance+capitalism%22+OR+%22wild+west%22)
